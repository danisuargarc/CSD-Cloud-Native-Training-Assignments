...
let orderCopy = (<any>Object).assign({}, order);
...
let printCapitalNames = function (...fiveNames: any) {
...
let printThirdElement = function (...elements: any) {
...
let retrievePin = function (org: any) {
